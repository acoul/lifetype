...
$messages['articles_order'] = 'Ordre dels articles';
$messages['articles_order_help'] = 'Ordre en que s\'han de mostrar els articles.';
...
$messages['read_service_agreement'] = 'Llegeix els termes i condicions d\'ús d\'aquest servei i prem el botó "Accepto" si hi està d\'acord';
...
$messages['register_need_confirmation'] = 'Se t\'ha enviat un missatge de correu electrònic amb instruccions per completar l\'activació del teu bloc. Consulta la teva bústia de correu electrònic, segueix les instruccions del missatge i el bloc s\'activarà de forma immediata';
...
$messages['error_invalid_activation_code'] = 'S\'ha produït un error, el codi de confirmació no és vàlid';
...
$messages['password_reset_subject'] = 'Canvi de clau d\'accés a LifeType';
...
$messages['login_perm_desc'] = 'L\'usuari pot accedir a la interfície d\'administració';
// admin permissions
...
$messages['update_plugin_settings_desc'] = 'L\'usuari pot actualitzar la configuració dels complements';
...
$messages['help_hard_recent_posts_max'] = 'Valor màxim per al nombre d\'articles recents mostrats a cada bloc. Si els usuaris especifiquen un valor superior a aquest, el valor de l\'usuari serà ignorat i el valor especificat aquí serà usat [ Valor per defecte = 25 ]';
...
$messages['add_album'] = 'Afegir àlbum';
$messages['editResource'] = 'Edita fitxer';
...
$messages['logout_destination_url'] = 'Adreça web on els usuaris seran enviats quan premin el botó "Sortir" a la interfície d\'administració, com per exemple la pàgina principal d\'aquest servei [ Valor per defecte = res ]';
...
$messages['basic_blog_permission'] = 'Permet a l\'usuari afegir, actualitzar i esborrar articles, enllaços i fitxers';
...
$messages['plugin_latest_version'] = 'Versions més recents disponibles: ';
$messages['check_versions'] = 'Comprova les versions';
$messages['lt_version_ok'] = 'La versió actual de LifeType esta al dia.';
$messages['lt_version_error'] = 'La versió més recent de LifeType és: ';
$messages['release_notes'] = 'Notes de la versió';
...
$messages['help_notify_new_blogs'] = 'Informar a l\'administrador d\'aquest servidor cada vegada que es registri un nou bloc a Lifetype';
