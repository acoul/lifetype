...
$messages['welcome_message'] = 'Bem-vind@ ao LifeType';
$messages['error_incorrect_username_or_password'] = 'Desculpe, senha ou usuário/a incorreto.';
$messages['error_dont_belong_to_any_blog'] = 'Desculpe, você não pertence a nenhum blog ainda.';
$messages['logout_message'] = 'Você foi desconectado/a com sucesso.';
$messages['logout_message_2'] = 'Clique <a href="%1$s">aqui</a> para voltar %2$s.';
$messages['error_access_forbidden'] = 'Acesso proibido. Você deve se autenticar antes.';
...
$messages['total_posts'] = 'Total Postagens';
$messages['total_comments'] = 'Total Comentários';
$messages['total_trackbacks'] = 'Total Trackbacks';
$messages['total_viewed'] = 'Total Visualizações';
$messages['in'] = 'In';

// menu options
$messages['newPost'] = 'Nova Postagem';
$messages['Manage'] = 'Gerenciar';
$messages['managePosts'] = 'Gerenciar Postagens';
$messages['editPosts'] = 'Postagens';
$messages['editArticleCategories'] = 'Categorias';
$messages['newArticleCategory'] = 'Nova Categoria';
$messages['manageLinks'] = 'Gerenciar Endereços';
$messages['editLinks'] = 'Endereços';
$messages['newLink'] = 'Novo Endereço';
$messages['editLink'] = 'Editar Endereços';
$messages['editLinkCategories'] = 'Endereço das Categorias';
$messages['newLinkCategory'] = 'Novo endereço da Categoria';
$messages['editLinkCategory'] = 'Editar endereço da Categoria';
$messages['manageCustomFields'] = 'Controle de Campo Personalizado';
$messages['blogCustomFields'] = 'Campo Personalizado';
$messages['newCustomField'] = 'Novo Campo Personalizado';
$messages['resourceCenter'] = 'Centro de Recursos';
$messages['resources'] = 'Recursos';
$messages['newResourceAlbum'] = 'Novo Álbum';
$messages['newResource'] = 'Novo Recurso';
$messages['controlCenter'] = 'Centro de Controle';
$messages['manageSettings'] = 'Configurações';
$messages['blogSettings'] = 'Configuração do Blog';
$messages['userSettings'] = 'Configurações do Usuário';
$messages['pluginCenter'] = 'Centro de Plugins';
$messages['Stats'] = 'Estatísticas';
$messages['manageBlogUsers'] = 'Gerenciar usuário do Blog';
$messages['newBlogUser'] = 'Novo/a usuário/a no Blog';
$messages['showBlogUsers'] = 'Usuários/as Blog';
$messages['manageBlogTemplates'] = 'Blog Templates';
$messages['newBlogTemplate'] = 'Novo Blog Template';
$messages['blogTemplates'] = 'Blog Templates';
$messages['adminSettings'] = 'Administração';
$messages['Users'] = 'Usuário';
$messages['createUser'] = 'Criar Usuário/a';
$messages['editSiteUsers'] = 'Usuários/as do Site';
$messages['Blogs'] = 'Gerenciar Blogs';
$messages['createBlog'] = 'Criar Blog';
$messages['editSiteBlogs'] = 'Blogs';
$messages['Locales'] = 'Gerenciar idioma';
$messages['newLocale'] = 'Novo idioma';
$messages['siteLocales'] = 'Idioma do Site';
$messages['Templates'] = 'Gerenciar';
$messages['newTemplate'] = 'Novo Template';
$messages['siteTemplates'] = 'Site Templates';
$messages['GlobalSettings'] = 'Configuração Global';
$messages['editSiteSettings'] = 'Geral';
$messages['summarySettings'] = 'Sumário';
$messages['templateSettings'] = 'Templates';
$messages['urlSettings'] = 'URLs';
$messages['emailSettings'] = 'Email';
$messages['uploadSettings'] = 'Subir';
...
$messages['searchSettings'] = 'Buscar';
$messages['cleanUpSection'] = 'Clean Up';
$messages['cleanUp'] = 'Clean Up';
$messages['editResourceAlbum'] = 'Editar Album';
...
$messages['topic_help'] = 'Título da postagem.';
$messages['text'] = 'Texto';
$messages['text_help'] = 'Texto para a postagem. Esta parte aparecerá sempre na página inicial.';
$messages['extended_text'] = 'Extender o Texto';
...
$messages['trackback_urls_help'] = 'Se o artigo que você quer emitir o trackback não suporta mecanismo Trackback Automóvel-Descobre, você pode pôr seu URL real do trackback aqui e usar uma linha nova para cada URL.';
$messages['post_slug'] = 'Slug';
$messages['post_slug_help'] = 'The slug will be used to generate nice permanent links.';
$messages['date'] = 'Data';
$messages['post_date_help'] = 'Data de publicação desta postagem.';
$messages['status'] = 'Situação';
$messages['post_status_help'] = 'Selecione uma da situação.';
$messages['post_status_published'] = 'Publicado';
$messages['post_status_draft'] = 'Rascunho';
$messages['post_status_deleted'] = 'Apagado';
$messages['post_categories_help'] = 'Selecionar uma ou mais categorias.';
$messages['post_comments_enabled_help'] = 'Habilitar comentários';
$messages['send_notification_help'] = 'Notificação de novo comentários.';
$messages['send_trackback_pings_help'] = 'Enviar trackbacks';
$messages['send_xmlrpc_pings_help'] = 'Enviar XMLRPC pings';
$messages['save_draft_and_continue'] = 'Salvar rascunho';
$messages['preview'] = 'Previsão';
...
$messages['error_missing_post_text'] = 'Escreva algum texto para a postagem';
$messages['error_adding_post'] = 'Houve um erro ao adicionar postagem';
$messages['post_added_not_published'] = 'Post added successfully but not published';
$messages['post_added_ok'] = 'Postagem adicionada com sucesso.';
...
$messages['bookmarklet_help'] = "Arraste para sua barra de ferramentas ou com clique com o botão esquerdo para adicionar em seu Favoritos.";
$messages['blogit_to_lifetype'] = "Blog It to LifeType!";
$messages['original_post'] = "(Postagem Original)";
...
$messages['editPost'] = 'Editar Postagem';
$messages['post_updated_ok'] = 'Post "%s" atualizado com sucesso.';
...
$messages['comment_status_nonspam'] = 'Não Spam';
...
$messages['show_in_main_page'] = 'Mostre na página inicial';
...
// new category
$messages['name'] = 'Nome';
$messages['category_name_help'] = 'Nome que será usado pela categoria.';
$messages['description'] = 'Descrição';
$messages['category_description_help'] = 'Descrição mais longa para esta categoria.';
$messages['show_in_main_page_help'] = 'Se as postagens desta categoria devem ser mostrados na página principal, ou somente quando esta categoria for escolhida.';
$messages['error_empty_name'] = 'Você deve fornecer um nome';
$messages['error_empty_description'] = 'Você deve fornecer uma descrição';
$messages['error_adding_article_category'] = 'Houve um erro ao adicionar a categoria nova. Verifique dados e tente-os outra vez';
$messages['category_added_ok'] = 'Categoria "%s" foi adicionada com sucesso ao blog';
$messages['add'] = 'Adicionar';
$messages['reset'] = 'Restaurar';

// update category
$messages['error_updating_article_category'] = 'There was an error updating the article category';
$messages['article_category_updated_ok'] = 'Categora "%s" foi atualizado com sucesso';
...
$messages['link_deleted_ok'] = 'Link "%s" foi atualizado com sucesso';
$messages['links_deleted_ok'] = '%s links deleted successfully';

// new link
$messages['link_name_help'] = 'Nome para esta ligação.';
$messages['link_url_help'] = 'Endereço para aonde aponta a ligação. Exemplo: http://www.nomedowebsitio.net/ (NOTA: http:// deve ser incluído!)';
$messages['link_description_help'] = 'Descrição breve desta ligação.';
$messages['link_feed_help'] = 'Uma ligação para algum RSS ou fontes Atom desta ligação pode também ser fornecida.';
$messages['link_category_help'] = 'Escolha uma das categorias disponíveis da ligação.';
$messages['error_adding_link'] = 'Houve um erro ao adicionar a ligação. Verifique os dados e tente outra vez';
$messages['error_invalid_url'] = 'O endereço não esta correto';
$messages['link_added_ok'] = 'Ligação "%s" foi adicionada com sucesso';
$messages['bookmarkit_to_lifetype'] = "Favoritos do LifeType!";
...
$messages['link_updated_ok'] = 'Link "%s" foi atualizado com sucesso';
...
// new link category
$messages['link_category_name_help'] = 'Nome a ser dado a esta categoria da ligação.';
$messages['error_adding_link_category'] = 'Houve um erro ao adicionar uma nova ligação';
$messages['link_category_added_ok'] = 'Ligação da categoria "%s" foi adicionada com sucesso';

// edit link category
$messages['error_updating_link_category'] = 'There was an error updating the link category. Please check the data and try again';
$messages['link_category_updated_ok'] = 'Link da categoria "%s" atualizado com sucesso';
$messages['error_fetching_link_category'] = 'There was an error fetching the link category';

// custom fields
$messages['type'] = 'Type';
$messages['hidden'] = 'Hidden';
$messages['fields_deleted_ok'] = '%s campos personalizado apagados com sucesso';
$messages['field_deleted_ok'] = 'O campos personalizados "%s" foram apagados com sucesso';
$messages['error_deleting_field'] = 'Houve um erro ao apagar o campo personalizado "%s"';
$messages['error_deleting_field2'] = 'There was an error deleting custom field with identifier "%s"';
$messages['error_incorrect_field_id'] = 'O campo personalizado identificado não é válido';

// new custom field
$messages['field_name_help'] = 'Identificador que será usado consultar ao valor deste campo nos postagens.';
$messages['field_description_help'] = 'Descrição breve deste campo que será mostrada ao adicionar ou ao editar postagens.';
$messages['field_type_help'] = 'Selecione um dos tipos de campo disponíveis.';
$messages['field_hidden_help'] = 'Se um campo for escondido, não se mostrará ao adicionar a ou ao editar uma postagem. Esta característica é usada principalmente para plugins.';
$messages['error_adding_custom_field'] = 'Houve um erro ao adicionar o campo personalizado. Verifique os dados e tente outra vez';
$messages['custom_field_added_ok'] = 'O Campo Personalizado "%s" adicionado com sucesso';
$messages['text_field'] = 'Campo de Texto';
$messages['text_area'] = 'Caixa de Texto';
$messages['checkbox'] = 'Caixa de Verificação';
$messages['date_field'] = 'Escolher Data';

// edit custom field
$messages['error_fetching_custom_field'] = 'There was an error fetching the custom field';
$messages['error_updating_custom_field'] = 'Houve um erro ao atualizar o campo personalizado. Verifique os dados e tente outra vez';
$messages['custom_field_updated_ok'] = 'Campo personalizado "%s" foi atualizado com sucesso';

// resources
$messages['root_album'] = 'Álbum Raiz';
$messages['num_resources'] = 'Número de Recursos';
$messages['total_size'] = 'Total do tamanho';
...
$messages['add_resource'] = 'Adicionar recurso';
$messages['add_resource_preview'] = 'Adicionar previsão';
$messages['add_resource_medium'] = 'Adicionar previsão média';
$messages['add_album'] = 'Adicionar álbum';

// new album
$messages['album_name_help'] = 'Nome curto para o album novo.';
$messages['parent'] = 'Raiz';
$messages['no_parent'] = 'Não-Raiz';
$messages['parent_album_help'] = 'Use isto ter albuns dentro dos albuns e organizar mais melhor seus arquivos.';
$messages['album_description_help'] = 'Descrição mais longa do conteúdo deste album.';
$messages['error_adding_album'] = 'There was an error adding the new album. Please check the data and try again';
$messages['album_added_ok'] = 'Album "%s" adicionado com sucesso';
...
$messages['resource_file_help'] = 'Arquivo que será adicionado ao blog atual. Use o "Adicione o campo" para subir mais de um arquivo ao mesmo tempo.';
$messages['add_field'] = 'Adicione o campo';
$messages['resource_description_help'] = 'Descrição mais longa do conteúdo deste arquivo.';
$messages['resource_album_help'] = 'Selecione o album em que o arquivo será adicionada..';
...
$messages['resource_updated_ok'] = 'Recursos "%s" atualizado com sucesso';

// blog settings
$messages['blog_link'] = 'Endereço do Blog';
$messages['blog_link_help'] = 'Permanent link to this blog';
$messages['blog_name_help'] = 'Título para este blog';
$messages['blog_description_help'] = 'Descrição mais longa sobre os conteúdos deste blog.';
$messages['language'] = 'Idioma';
$messages['blog_language_help'] = 'O idioma para os textos deste blog, no lado do público e administrativo.';
$messages['max_main_page_items'] = 'Número dos artigos na página principal';
$messages['max_main_page_items_help'] = 'Número de postagens que devem ser indicadas todas as vezes na página principal do blog.';
$messages['max_recent_items'] = 'Número de artigos recentes';
$messages['max_recent_items_help'] = 'Número máximo de postagens que serão mostradas como recentes na página inicial.';
$messages['template'] = 'Template';
$messages['choose'] = 'Escolha';
$messages['blog_template_help'] = 'Indique o template que será usado na tela de contéudo do blog. Esta lista inclui os templates globais e instalados somente para este blog.';
$messages['use_read_more'] = 'Use "mais..." no endereço da postagem';
$messages['use_read_more_help'] = 'Se habilitado, somente o digitado em "Texto" será apresentado na página principal. Ao fim indicar "Texto Extendido", um endereço como "mais..." será adicionado a cada postagem.';
$messages['enable_wysiwyg'] = 'Habilitar o editor visual para postagens';
$messages['enable_wysiwyg_help'] = 'Habilitar um editor mais poderoso, editor gráfico do HTML. O editor trabalha somente no Internet Explorer 5.5 e Mozilla 1.3 ou versões mais recentes.';
$messages['enable_comments'] = 'Habilitar comentários';
$messages['enable_comments_help'] = 'Habilitar comentários para todas as postagens.';
$messages['show_future_posts'] = 'Mostre as futuras postagens no calendário';
$messages['show_future_posts_help'] = 'As postagens que têm uma data no futuro devem aparecer no calendário e visível aos usuários.';
$messages['comments_order'] = 'Ordem dos comentários';
$messages['comments_order_help'] = 'Ordem em que os comentários devem ser indicados na página inicial.';
$messages['articles_order'] = 'Ordem dos artigos';
$messages['articles_order_help'] = 'Ordem em que os artigos devem ser indicados.';
$messages['oldest_first'] = 'O primeiro o mais velho';
$messages['newest_first'] = 'O primeiro o mais novo';
$messages['categories_order'] = 'Ordem das categorias';
$messages['categories_order_help'] = 'Ordem em que as categorias devem ser indicadas na página inicial.';
$messages['most_recent_updated_first'] = 'O mais recentemente atualizado';
$messages['alphabetical_order'] = 'Ordem Alfabetica';
...
$messages['select'] = 'Selecionar';
$messages['error_updating_settings'] = 'Houve um erro ao atualizar as configurações do blog. Verifique os dados e tente-os outra vez';
$messages['error_invalid_number'] = 'O número não está correto';
$messages['error_incorrect_time_offset'] = 'The time offset is not valid';
$messages['blog_settings_updated_ok'] = 'Atualizado com sucesso as configurações';
$messages['hours'] = 'Horas';

// user settings
$messages['username_help'] = 'Nome de usuário/a Público. Não pode ser mudado.';
$messages['full_name'] = 'Nome Completo';
$messages['full_name_help'] = 'Coloque o nome completo';
$messages['password_help'] = 'Escreva e confirme a nova senha, ou deixe vazio para nenhuma mudança.';
$messages['confirm_password'] = 'Confirme a senha';
$messages['email'] = 'Email';
$messages['email_help'] = 'Endereço eletrônico para onde será enviado as notificações.';
$messages['bio'] = 'Sua biografia';
$messages['bio_help'] = 'Uma descrição mais longa do/a usuario/a.';
$messages['picture'] = 'Figuras';
$messages['user_picture_help'] = 'Adicione aqui uma imagem sua para este blog.';
$messages['error_invalid_password'] = 'A senha esta incorreta. Certifique-se que não é seja muito curto';
$messages['error_passwords_dont_match'] = 'Desculpe, as senhas não combinam';
$messages['error_updating_user_settings'] = 'Houve um erro ao atualiza as configurações do usuário. Verifique os dados e tente-os outra vez';
$messages['user_settings_updated_ok'] = 'Atualizado com sucesso as configurações';
$messages['resource'] = 'Recursos';

// plugin centre
$messages['identifier'] = 'Identificador';
$messages['error_plugins_disabled'] = 'Desculpe, Plugins esta desabilitado.';

// blog users
$messages['revoke_permissions'] = 'Revoke permissions';
$messages['error_no_users_selected'] = 'Não havia nenhum usuário selecionado';
$messages['user_removed_from_blog_ok'] = 'User "%s" does not have permissions to access this blog any more';
$messages['users_removed_from_blog_ok'] = '%s os usuários não têm mais o acesso a este blog';
...
// new blog user
$messages['new_blog_username_help'] = 'Nome de usuário/a a quem você quer dar acesso a este blog. Os/as novos/as usuários/as terão somente o acesso "Gerenciador" e "Recursos" das seções.';
$messages['send_notification'] = 'Enviar notificação';
$messages['send_user_notification_help'] = 'Enviar notificação para correio-eletrônico deste usuário.';
$messages['notification_text'] = 'Texto de Notificação';
$messages['notification_text_help'] = 'Texto que será incluído na mensagem da notificação.';
$messages['error_adding_user'] = 'Houve um erro ao criar novo usuário. Verifique por favor os dados e tente-os outra vez';
$messages['error_empty_text'] = 'Você deve fornecer algum texto';
$messages['error_adding_user'] = 'Houve um erro ao adicionar o usuário. Verifique os dados e tente-os outra vez';
$messages['error_invalid_user'] = 'The user "%s" is not valid or does not exist';
$messages['user_added_to_blog_ok'] = 'Usuário/a "%s" recebeu acesso a este blog com sucesso';

// blog templates
$messages['error_no_templates_selected'] = 'Não havia nenhum template selecionado';
...
$messages['template_removed_ok'] = 'Template "%s" apagado com sucesso';
$messages['templates_removed_ok'] = '%s templates apagados com sucesso';

// new blog template
$messages['template_installed_ok'] = 'Template "%s" adicionado com sucesso';
...
$messages['error_no_new_templates_found'] = 'Nenhum template novo foi encontrado';
...
$messages['error_missing_base_files'] = 'Alguns arquivos básicos do template estão faltando';
$messages['error_unpacking'] = 'Houve um erro ao descompactar o arquivo';
$messages['error_forbidden_extensions'] = 'O template inclui arquivos com extensões proibidas';	
$messages['error_creating_working_folder'] = 'Houve um erro ao criar a pasta temporária ao descompactar o arquivo';
$messages['error_checking_template'] = 'Houve um erro a verificar o template: %s';
$messages['template_package'] = 'Pacote template';
$messages['blog_template_package_help']  = 'Use esse formulário para subir um novo template, que estará disponível para todos/as usuários de blogs local. Senão for possível subir os pacotes por esse formulário, suba os template manualmente e coloque dentro de <b>%s</b>, que é a pasta aonde os templates do seu blog ficam armazenados e clique no botão "<b>Buscar templates</b>". LifeType irá buscar na pasta e adicionará automaticamente todo novo template que puder encontrar.';
$messages['scan_templates'] = 'Buscar Templates';

// site users
$messages['user_status_active'] = 'Ativar';
$messages['user_status_disabled'] = 'Desabilitar';
...
$messages['user_deleted_ok'] = 'Usuário/a "%s" desabilitado com sucesso';
$messages['users_deleted_ok'] = '%s usuários/as desabilitados com sucesso';

// create user
$messages['user_added_ok'] = 'Usuário/a "%s" adicionado com sucesso';
$messages['user_status_help'] = 'Situação atual para esse/a usuário/a';
$messages['user_blog_help'] = 'Blog a quem este usuário/a será atribuído inicialmente.';
...
$messages['user_updated_ok'] = 'Usuário/a "%s" foi atualizado com sucesso';
...
$messages['blogs_deleted_ok'] = '%s blogs apagado com sucesso';
...
// create blog
$messages['error_adding_blog'] = 'Houve um erro ao criar o blog. Verifique os dados e tente-os outra vez';
$messages['blog_added_ok'] = 'Blog "%s" adicionado com sucesso';

// edit blog
$messages['blog_status_help'] = 'Blog status';
$messages['blog_owner_help'] = 'Usuário/a que será ajustado/a como o/a proprietário/a, com todos os controle de ajustes do blog.';
$messages['users'] = 'Usuários/as';
...
$messages['add_or_remove'] = 'Adicionar ou rmeover usuários/as';

// site locales
$messages['locale'] = 'Idioma';
$messages['locale_encoding'] = 'Codificação';
$messages['locale_deleted_ok'] = 'Idioma "%s" apagado com sucesso';
...
// add locale
$messages['error_invalid_locale_file'] = 'O arquivo de idioma é inválido';
$messages['error_no_new_locales_found'] = 'Nenhum arquivo de idioma foi encontrado';
...
$messages['scan_locales'] = 'Buscar Idiomas';
$messages['add_locale_help'] = 'Use este formulário para subir o o novo idioma. Senão consegui através deste formulário, suba o arquivo de idioma manualmente, coloque em <b>./locales/</b>, que é a pasta aonde os arquivos de idioma ficam e clique no botão "<b>Buscar Idiomas</b>". LifeType irá fazer uma buscar dentro da pasta automaticamente pelo arquivo de idioma.';
...
// global settings
$messages['site_config_saved_ok'] = 'Salvo com sucesso as configurações do Site';
$messages['error_saving_site_config'] = 'Houve um erro ao salvar as configurações';
/// general settings
$messages['help_comments_enabled'] = 'Habilitar comentário para novo por padrão. [Padrão = Sim]';
$messages['help_beautify_comments_text'] = 'Se habilitados, os comentários afixados por usuários serão formatados adicionando parágrafos e automóvel-ligando todo o URLs. [Padrão = Sim]';
...
$messages['help_summary_show_agreement'] = 'Mostre um texto do acordo e faça usuários aceitá-lo antes de proseguir ao processo do registo [Padrão = Sim]';
...
$messages['help_summary_disable_registration'] = 'Desabilitar o registro de novos/as usuários/as e blogs pela interface pública. [Padrão = Sim]';
// templates
...
// search
$messages['help_search_engine_enabled'] = 'Enable the search engine. [Padrão = Sim]';
$messages['help_search_in_custom_fields'] = 'Procurar em campo personalizado. [Padrão = Sim]';
$messages['help_search_in_comments'] = 'Procurar em comentários. [Padrão = Sim]';
...
/// summary ///
// front page
$messages['summary'] = 'Sumário';
$messages['register'] = 'Registrar';
$messages['summary_welcome'] = 'Bem-vind@!';
$messages['summary_most_active_blogs'] = 'Blogs ativos';
$messages['summary_most_commented_articles'] = 'Artigos comentados';
$messages['summary_most_read_articles'] = 'Ler Artigos';
$messages['password_forgotten'] = 'Esqueceu sua senha?';
$messages['summary_newest_blogs'] = 'Blogs recentes';
$messages['summary_latest_posts'] = 'Postagens antigas';
$messages['summary_search_blogs'] = 'Procurar Blogs';
...
// blog profile
$messages['blog'] = 'Blog';
$messages['latest_posts'] = 'Próximas postagens';

// registration
$messages['register_step0_title'] = 'Termo de aceitação do Serviço';
$messages['agreement'] = 'Acordo'; 
$messages['decline'] = 'Rejeitar';
$messages['accept'] = 'Aceitar';
$messages['read_service_agreement'] = 'Leia por favor os termos deste serviço e clique em botão "Aceitar" para concordar';
$messages['register_step1_title'] = 'Críe um usuário [1/4]';
$messages['register_step1_help'] = 'Necessário criar um(a) usuário/a para seguir a criação do novo blog. Este usuário será o proprietário do blog e terá o acesso a todas suas funcionalidades.';
$messages['register_next'] = 'Próximo';
$messages['register_back'] = 'Anterior';
$messages['register_step2_title'] = 'Críe um blog [2/4]';
$messages['register_blog_name_help'] = 'Nome para seu blog novo';
$messages['register_step3_title'] = 'Escolha um template [3/4]';
$messages['step1'] = 'Etapa 1';
$messages['step2'] = 'Etapa 2';
$messages['step3'] = 'Etapa 3';
$messages['register_step3_help'] = 'Selecione por favor um dos templates disponíveis como o padrão para seu blog. Se você não gostar de nenhum, pode sempre ser mudado.';
$messages['error_must_choose_template'] = 'Escolha um template';
$messages['select_template'] = 'Selecione template';
$messages['register_step5_title'] = 'Felicitações! [4/4]';
$messages['finish'] = 'Finalizado';
$messages['register_need_confirmation'] = 'Foi enviado uma mensagem de confirmação para seu correio-eletrônico, clique no endereço que aparece na mensagem para começar a postar no seu blog!';
$messages['register_step5_help'] = 'Parabéns, seu usuário novo e o blog foram criados com sucesso!';
$messages['register_blog_link'] = 'Se você gostaria de olhar seu blogue novo, você pode ir lá agora: <a href="%2$s">%1$s</a>';
$messages['register_blog_admin_link'] = 'Se você prefere começar publicar imediatamente, clique para ir à <a href="admin.php">interface de administração</a>';
$messages['register_error'] = 'Houve um erro durante o processo';
$messages['error_registration_disabled'] = 'Desculpe, o registro de novos blogs neste local foi desabilitado';
// registration article topic and text
$messages['register_default_article_topic'] = 'Felicitações!';
...
// confirmation email
$messages['register_confirmation_email_text'] = 'Clique nesta ligação para ativar seu blog:

%s

Have a nice day';
$messages['error_invalid_activation_code'] = 'Desculpe, o código da confirmação é inválido';
$messages['blog_activated_ok'] = 'Felicitações, seu usuário novo e o blog foram validados com sucesso!';
// forgot your password?
$messages['reset_password'] = 'Restaurar sua senha';
$messages['reset_password_username_help'] = 'Nome da senha que do usuário cuja você gostaria de restaurar.';
$messages['reset_password_email_help'] = 'Correio-eletrônico que foi usado registar este usuário.';
$messages['reset_password_help'] = 'Use este formulário para restaurar a senha de seu usuário, se você não a recordar. Digite o nome do/a usuário/a cuja a senha você gostaria de restaurar, e o correio-eletrônico que foi usado registar este/a usuário/a.';
...
$messages['change_password'] = 'Inserir nova senha';
$messages['change_password_help'] = 'Digite e confirme sua senha nova.';
$messages['new_password'] = 'Nova Senha';
$messages['new_password_help'] = 'Digite aqui sua nova senha.';
$messages['password_updated_ok'] = 'Sua senha foi atualizada com sucesso';
...
$messages['error_invalid_blog_category'] = 'Categoria de Blog inválida';
$messages['error_adding_blog_category'] = 'Houve um erro ao adicionar a categoria do blogue';
$messages['newBlogCategory'] = 'Nova Categoria do Blog';
$messages['editBlogCategories'] = 'Categorias do Blog';
$messages['blog_category_added_ok'] = 'Categoria de Blog adicionada com sucesso';
...
$messages['blog_category_deleted_ok'] = 'Categoria de Blog "%s" foi apagada com sucesso';
$messages['blog_categories_deleted_ok'] = '%s categoria de blog apagado com sucesso';
$messages['error_deleting_blog_category2'] = 'Houve um erro ao remove a categoria do blog com a identificação  %s';
$messages['blog_category'] = 'Categoria do Blog';
$messages['blog_category_help'] = 'Categoria global do blog atribuída a este blog.';
...
$messages['manageGlobalArticleCategory'] = 'Categorias Global de Artigos';
$messages['newGlobalArticleCategory'] = 'Nova Categoria Global do artigo';
$messages['editGlobalArticleCategories'] = 'Global Article Categories';
$messages['global_category_name_help'] = 'Nome da categoria global nova do artigo.';
$messages['global_category_description_help'] = 'Descrição da categoria global nova do artigo.';
$messages['error_incorrect_global_category_id'] = 'Categoria global inválida do artigo';
$messages['global_category_deleted_ok'] = 'Categoria de artigo "%s" apagado com sucesso';
$messages['global_category_added_ok'] = 'Categoria global "%s" adicionado com sucesso';
$messages['error_deleting_global_category2'] = 'Houve um erro ao remover a categoria do artigo com id = %s';
...
$messages['error_comment_too_big'] = 'O comentário é demasiado grande';
$messages['error_you_have_been_blocked'] = 'Blocked: this request was not completed.';
$messages['created'] = 'Criado';
$messages['view'] = 'Visualizar';
$messages['editUser'] = 'Editar Usuário/ar';
...
$messages['register_default_album_name'] = 'Geral';
$messages['register_default_album_description'] = 'Use this album to upload new pictures.';
$messages['show_in_summary'] = 'Apresentar em Sumário';
$messages['show_in_summary_help'] = 'Inclua este blog na página sumária deste site.';

$messages['saving_message'] = 'Salvando ...';
$messages['show_option_panel'] = 'Apresentar Opções';
$messages['hide_option_panel'] = 'Hide Options';

$messages['quick_launches'] = 'Lançamentos Rápidos';
...
$messages['error_comment_status'] = 'Selecione situação de comentário.';
$messages['admin_mode'] = 'Admin Mode';
$messages['administrate_user_blog'] = 'Administrate this blog';
$messages['trackbacks_updated_ok'] = '%s trackbacks atualizado com sucesso';
$messages['trackback_updated_ok'] = 'Trackback atualizado com sucesso';
$messages['error_trackback_status'] = 'Selecione uma Situação válida';
$messages['select'] = 'Selecionar';
$messages['remove_selected'] = 'Remover Selecionados';

$messages['notification_subject'] = 'LifeType Sistema de Notificação';
$messages['error_no_trackback_links_sent'] = 'Perigo: No Trackbacks were sent.';
...
$messages['blog_categories'] = 'Blog Categorias';
...
$messages['default_send_notification'] = 'Padrão de Enviar Notificação';
...
$messages['warning_autosave_message'] = '<img src="imgs/admin/icon_warning-16.png" alt="Error" class="InfoIcon"/><p class="ErrorText">Você parece ter saido sem conservar sua postagem. Se assim, você pode <a href="#" onclick="restoreAutoSave();">clicar aqui para restaurar</a> ou <a href="#" onclick="eraseAutoSave();">aqui para apagar</a>.</p>';

$messages['check_username'] = 'Verificando';
$messages['check_username_ok'] = 'O nome do usuário está disponível!';
$messages['error_username_exist'] = 'Desculpe! O nome do usuário não está disponível, tente outros.';

$messages['error_rule_email_dns_server_temp_fail'] = 'Falha temporária - tente outra vez mais tarde.';
$messages['error_rule_email_dns_server_unreachable'] = 'Email server unreachable.';
$messages['error_rule_email_dns_not_permitted'] = 'E-mail não permitido.';

$messages['blog_users_help'] = 'Usuários/as que têm o acesso a este blog.';
...
$messages['first_day_of_week_label'] = 'Primeiro dia da semana';
$messages['first_day_of_week_help'] = 'Primeiro dia da semana no calendário.';
...
$messages['registration_default_subject'] = 'LifeType confirmação do registo';
...
$messages['monthsshort'] = Array( 'Jan', 'Fev', 'Mar', 'Abr', 'Mai', 'Jun', 'Jul', 'Ago', 'Set', 'Out', 'Nov', 'Dez' );
$messages['weekdaysshort'] = Array( 'Dom', 'Seg', 'Ter', 'Qua', 'Qui', 'Sex', 'Sab' );

$messages['search_type'] = 'Procurar em';
$messages['posts'] = 'Postagens';
$messages['blogs'] = 'Blogs';
$messages['resources'] = 'Recursos';
$messages['upload_in_progress'] = 'Subindo. Aguarde...';
...
$messages['Miscellaneous'] = 'Miscelânea';
$messages['Plugins'] = 'Plugins';

$messages['auth_img'] = 'Código de Autenticação';
$messages['auth_img_help'] = 'Digite o código que você vê na imagem abaixo.';

$messages['global_category'] = 'Categoria Global';
$messages['global_article_category_help'] = 'Uma categoria abragente para esta postagem.';

$messages['password_reset_subject'] = 'LifeType Requer Senha';
...
$messages['permissionsList'] = 'Permissões';
$messages['newPermission'] = 'Nova Permissão';
$messages['permission_name_help'] = 'Nome original para a permissão';
$messages['permission_description_help'] = 'Descrição para se dada permissão';
...
$messages['error_permission_required'] = 'Você não tem permissão para essa ação';
$messages['user_permissions_updated_ok'] = 'As permissões do usuário foi atualizado com sucesso';

// blog permissions
$messages['add_album_desc'] = 'Adicionar novos albuns';
$messages['add_blog_template_desc'] = 'Add new blog templates';
$messages['add_blog_user_desc'] = 'Add new blog users';
$messages['add_category_desc'] = 'Adicionar novas categorias';
$messages['add_custom_field_desc'] = 'Adicionar novos campos personalizados';
$messages['add_link_desc'] = 'Adicionar novo endereço';
$messages['add_link_category_desc'] = 'Add new link categories';
$messages['add_post_desc'] = 'Adiconar novas postagens';
$messages['add_resource_desc'] = 'Adicionar novos recursos';
$messages['blog_access_desc'] = 'Permita o acesso a este blog';
$messages['update_album_desc'] = 'Atualizar albuns existentes';
$messages['update_blog_desc'] = 'Update the blog settings';
$messages['update_blog_template_desc'] = 'Update a blog template';
$messages['update_blog_user_desc'] = 'Atualizar permissões de usuarios/as';
$messages['update_category_desc'] = 'Atualizando categorias existentes';
...
$messages['view_posts_desc'] = 'Visualizar postagem do blog';
$messages['view_resources_desc'] = 'View the blog resources';
$messages['view_trackbacks_desc'] = 'View the blog trackbacks';
$messages['login_perm_desc'] = 'É permitido acesso ao usuário';
// admin permissions
...
$messages['summary_welcome_msg'] = 'Bem-vindo/a, %s!';
$messages['summary_go_to_admin'] = 'Voltar para interface administrativa';
...
$messages['error_cannot_login'] = 'Desculpe, não é permitido acessar com esse login';
$messages['admin_user_permissions_help'] = 'Site-wide permissions granted to this user';

$messages['permissions'] = 'Permissões';
$messages['blog_user_permissions_help'] = 'Permissões atribuídas a este usuário neste blog';
$messages['pluginSettings'] = 'Configuração de Plugin';
$messages['user_can_override'] = 'Users can override';
$messages['user_cannot_override'] = 'Users cannot override';
$messages['global_plugin_settings_saved_ok'] = 'Salvo com sucesso as alterações em Global plugin';
$messages['error_updating_global_plugin_settings'] = 'There was an error saving the the global plugin settings';
$messages['error_incorrect_value'] = 'O valor não está correto';
$messages['parameter'] = 'Parametro';
$messages['value'] = 'Valor';
$messages['override'] = 'Override';
$messages['editCustomField'] = 'Edit Custom Field';
$messages['view_blog_stats_desc'] = 'Visualizar as estatísticas do blog';
...
$messages['show_comments_max'] = 'Comentários por página';
$messages['show_comments_max_help'] = 'Número máximo dos comentários por página [ Padrão = 20 ]';
$messages['hard_show_comments_max_help'] = 'Hard limit for the number of comments per page [ Padrão = 50 ]';
...
$messages['register_step2_help'] = 'Forneça as informações requerida para criar um blog.';

$messages['create_date'] = 'Criado na data';

$messages['insert_media'] = 'Inserir mídia';
...
$messages['error_invalid_blog_name'] = 'O nome do blog não é válido';
...
$messages['user_updated_ok'] = 'Usuário/a "%s" foi alterado com sucesso.';
...
$messages['error_select_status'] = 'Selecione uma situação válida';
$messages['error_invalid_blog_name'] = 'Desculpe, nome do blog não é válido';
...
$messages['posted_by_help'] = 'Selecionar o/a dono/a desse artigo';
$messages['insert_player'] = 'Inserir  Player';
...
$messages['check_versions'] = 'Verificar versão';
