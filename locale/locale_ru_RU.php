...
$messages['locale_description'] = 'Russian Translation (UTF-8)';
...
$messages['about_myself'] = 'Об авторе';
...
$messages['trackbacks_for_article'] = 'Трекбэки для публикации';
$messages['trackback_excerpt'] = 'Сообщение';
$messages['trackback_weblog'] = 'Блог';
$messages['search_results'] = 'Результаты поиска';
$messages['search_matching_results'] = 'По Вашему запросу найдено следующее: ';
$messages['search_no_matching_posts'] = 'Не найдено соответствующих сообщений';
$messages['read_more'] = '(Читать дальше...)';
$messages['syndicate'] = 'Синдикат';
$messages['main'] = 'Главная';
$messages['about'] = 'О нас';
$messages['download'] = 'Загрузить';
$messages['error_incorrect_email_address'] = 'Некорректный E-Mail';
...
$messages['error_fetching_category'] = 'Указанный Вами раздел не найден';
...
$messages['error_parameter_missing'] = 'В Вашем запросе не хватает параметра.';
...
$messages['previous_post'] = 'Предыдущая';
$messages['next_post'] = 'Следующая';
$messages['comment_default_title'] = '(неограничено)';
$messages['guestbook'] = 'Гостевая книга';
$messages['trackbacks'] = 'Трекбэки';
$messages['menu'] = 'Меню';
$messages['albums'] = 'Альбомы';
$messages['admin'] = 'Управление';
$messages['links'] = 'Ссылки';
$messages['categories'] = 'Разделы';
$messages['articles'] = 'Публикации';
...
$messages['uncompressed_size'] = 'Несжатый размер';
$messages['files'] = 'файлов';
$messages['format'] = 'Формат';
$messages['length'] = 'Продолжительность';
$messages['sample_rate'] = 'Частота дискретизации';
$messages['video_codec'] = 'Кодек видео';
$messages['audio_codec'] = 'Кодек аудио';
